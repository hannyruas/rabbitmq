...
SONGS_INFO = "SELECT tracks.Name, genres.Name, artists.Name FROM tracks INNER JOIN genres ON " \
             "genres.GenreId=tracks.GenreId JOIN albums ON albums.AlbumId = tracks.AlbumId " \
